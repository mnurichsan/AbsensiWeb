                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="nip" name="nip" class="form-control form-control-user @error('nip') is-invalid @enderror" value="{{ old('nip') }}" required autocomplete="nip" autofocus placeholder="Enter nip Address..." autocomplete="off">
                                            @error('nip')
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user @error('password') is-invalid @enderror" required autocomplete="current-password" placeholder="Password">
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
